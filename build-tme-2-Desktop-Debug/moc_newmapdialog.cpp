...
static const char qt_meta_stringdata_NewMapDialog[] = {
    "NewMapDialog\0\0package\0"
    "makeNew(std::tuple<int,int,int,int>)\0"
    "sendNewMapInfo()\0"
};
...
void NewMapDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->makeNew((*reinterpret_cast< std::tuple<int,int,int,int>(*)>(_a[1]))); break;
        case 1: _t->sendNewMapInfo(); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData NewMapDialog::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject NewMapDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_NewMapDialog,
      qt_meta_data_NewMapDialog, &staticMetaObjectExtraData }
};
...
// SIGNAL 0
void NewMapDialog::makeNew(std::tuple<int,int,int,int> _t1)
{
